...
public class TulosTest {
    ...
    public void huonoimmanJaParhaimmanSopivuudenHakuToimii() {
        double sopivuusero = this.hahmojako.getTulokset().get(0).getParasSopivuus() - this.hahmojako.getTulokset().get(0).getHuonoinSopivuus();
        assertEquals(20.0, sopivuusero, 0.1);
    }
    
    @Test
    public void sopivuuskeskiarvonHakuToimii() {
        double ka = this.hahmojako.getTulokset().get(0).getSopivuuskeskiarvo();
        assertEquals(86.0, ka, 0.1);
    }
    
    @Test
    public void mediaanisopivuudenHakuToimii() {
        double med = this.hahmojako.getTulokset().get(0).getMediaanisopivuus();
        assertEquals(87.5, med, 0.1);
    }
    
    @Test
    public void pelaajienHahmojenHakuToimii() {
        int hahmo = this.hahmojako.getTulokset().get(0).getPelaajienHahmot().get(6);
